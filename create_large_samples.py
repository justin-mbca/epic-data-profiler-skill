...
df.to_csv('sample_epic_large.csv', index=False)
df.to_json('sample_epic_large.json', orient='records', lines=False)
df.to_parquet('sample_epic_large.parquet')
print('Large sample files created.')
